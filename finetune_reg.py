...
def main(args):
    ...
    encoder_opt = torch.optim.Adam(args.encoder_lr, parameters=encoder_params)
    head_opt = torch.optim.Adam(args.head_lr, parameters=head_params)
